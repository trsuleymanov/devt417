    ...
    <div class="content">
        <content>
            ...
            <div class="reservation__menu">
                <p class="name_cart">АКТИВНЫЕ БРОНИРОВАНИЯ</p>
